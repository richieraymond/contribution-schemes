...
@Component({
    selector: 'app-view-education-levels',
    templateUrl: './view-education-levels.component.html',
    styleUrls: ['./view-education-levels.component.scss']
})
export class ViewEducationLevelsComponent extends CommonComponent implements OnInit {
    cols: any;
    records: any = [];
    private endPoint = 'refdata/educationlevel';
        ...
        this.sendRequestToServer(this.endPoint,
            ...
            function (response: any) {
                ...
                if (serverResponse.success) {
                    controller.records = serverResponse.educationlevels;
                } else {
    ...
    createRecord() {
        this.parentRouter.navigate(['refdata/add-education-level']);
    }

    editRecord(rowData: any) {
        this.parentRouter.navigate(['refdata/edit-education-level', rowData.id]);
    }
