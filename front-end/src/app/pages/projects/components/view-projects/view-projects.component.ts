...
export class ViewProjectsComponent extends CommonComponent implements OnInit {
    cols: any;
    projects: any = [];
    private endPoint = 'scheme/project';
    ...
    ngOnInit(): void {
        this.cols = [
            ...
            {field: 'is_recurring', header: 'Is recurring?'},
            {field: 'require_fixed_amounts', header: 'Fixed amount?'},
            {field: 'amount', header: 'Amount'},
            {field: 'allow_installments', header: 'Allow installments?'},
    ...
    createRecord() {
        this.parentRouter.navigate(['project/add-project']);
    }

    editProject(rowData: any) {
        this.parentRouter.navigate(['project/edit-project', rowData.id]);
    }
