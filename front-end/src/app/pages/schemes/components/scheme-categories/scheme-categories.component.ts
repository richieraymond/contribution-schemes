...
@Component({
    selector: 'app-scheme-categories',
    templateUrl: './scheme-categories.component.html',
    styleUrls: ['./scheme-categories.component.scss']
})
export class SchemeCategoriesComponent extends CommonComponent implements OnInit {
    cols: any;
    records: any = [];
    private endPoint = 'scheme/type';
        ...
        this.sendRequestToServer(this.endPoint,
            ...
            function (response: any) {
                ...
                if (serverResponse.success) {
                    controller.records = serverResponse.types;
                } else {
    ...
    createRecord() {
        this.parentRouter.navigate(['scheme/add-scheme-category']);
    }

    editRecord(rowData: any) {
        this.parentRouter.navigate(['scheme/edit-scheme-category', rowData.id]);
    }
