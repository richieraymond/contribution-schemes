...
export class ManageUserGuard extends CommonComponent implements CanActivate {
    ...
    canActivate(
        ...
        this.commonService.showError('You do not have the required permission to access this resource');
        return this.user.canManageSchemeUsers;
    }
